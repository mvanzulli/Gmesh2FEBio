...
//+
Extrude {0, 0, 0.1} {
  Curve{6}; Curve{5}; Curve{8}; Curve{7}; Curve{2}; Curve{3}; Curve{4}; Curve{1}; 
}
//+
Curve Loop(2) = {29, 33, 37, 25};
//+
Curve Loop(3) = {21, 17, 13, 9};
//+
Plane Surface(41) = {2, 3};
//+
Surface Loop(1) = {12, 1, 40, 28, 32, 36, 41, 16, 20, 24};
//+
Volume(1) = {1};
//+
Physical Volume("pipe", 42) = {1};
//+
Line(38) = {1, 12};
